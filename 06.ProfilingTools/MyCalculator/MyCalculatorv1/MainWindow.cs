...
public class MainWindow : Window, IComponentConnector
{
	...
	private void result()
	{
		...
		try
		{
			num2 = Convert.ToDouble(tb.Text.Substring(0, num));
			num3 = Convert.ToDouble(tb.Text.Substring(num + 1, tb.Text.Length - num - 1));
		}
		catch (Exception)
		{
			MessageBox.Show("Wrong expression format");
			return;
		}
		switch (text)
		{
